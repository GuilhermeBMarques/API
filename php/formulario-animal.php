...
if (isset($_POST['submit'])) {
    ...
    $stmt->bind_param("sssssssssssss", $nome_animal, $responsavel_animal, $gmail_animal, $Whatsapp_animal, $arquivo_principal, $arquivos_secundarios, $especie_animal, $sexo_animal, $faixaEtaria_animal, $porte_animal, $descricao_animal, $estado_animal, $cidade_animal);
