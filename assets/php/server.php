...
$username = "tdssl231t_guilhermemarques"; // Nome de usuário do banco de dados
$password = "rr8rZaDDCiulwrQ"; // Senha do banco de dados
$dbname = "tdssl231t_guilhermemarques"; // Nome do banco de dados
